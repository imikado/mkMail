<?php
class model_blackwords extends abstract_model{
	
	protected $sClassRow='row_blackwords';
	
	protected $sTable='blackwords';
...
class row_blackwords extends abstract_row{
	
	protected $sClassModel='model_blackwords';
